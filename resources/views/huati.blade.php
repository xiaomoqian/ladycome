...
<html lang="zh-CN">
  ...
  @endforeach
    ...
    <link rel="stylesheet" href="{{asset('css/huati.css') }}">
      ...
      <div class="container-news">
        <div class="row">
          <div class="container-news__left col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="nav">当前位置：<a href="{{route('index')}}">多广网</a>><a href="{{route('ht')}}">话题广场</a></div>
            <ul class="container-news__left--box">
              @foreach($classfiy as $key => $value)
                <li>
                  <a href="{{route('htinfo',['id' => $value['id']])}}">
                    ...
                    <div>
                      ...
                      <div>
                        <span>{{$value->articel_count}} 精华内容</span>
                      </div>
                    </div>
                  </a>
                </li>
