    ...
    <div class="container-box">
      <div class="row">
        <div class="container-box__content">
          <div class="nav">当前位置：<a href="{{route('index')}}">多广网</a>><a href="/utils">工具</a>>公积金贷款计算器</div>
          <div class="hd">
            <div class="tool-nav clearfix">
              <a stat-info="jrmall_pc_fangdaical_fangdai" href="/utils" title="房贷计算器">房贷计算器</a>
              <a stat-info="jrmall_pc_fangdaical_fangdai" href="/utils/gjj" title="公积金贷款计算器" class="active">公积金贷款计算器</a>
          ...
          <iframe id="FF" src="{{asset('tool/gongjijin/gongjijin.html') }}" frameborder="0" style="width:100%;"></iframe>
          <div class="ad">
