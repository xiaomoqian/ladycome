    ...
    <div class="container-box">
      <div class="row">
        <div class="container-box__content">
          <div class="nav">当前位置：<a href="{{route('index')}}">多广网</a>><a href="/utils">工具</a>>理财收益计算器</div>
          <div class="hd">
            <div class="tool-nav clearfix">
              ...
              <a stat-info="jrmall_pc_fangdaical_licai" href="/utils/licai" title="理财收益计算器" class="active">理财收益计算器</a>
          ...
          <iframe id="FF" src="{{asset('tool/licai/licai.html') }}" frameborder="0" style="width:100%;"></iframe>
