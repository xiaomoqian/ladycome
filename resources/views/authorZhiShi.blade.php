      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-header">
            <button class="layui-btn" onclick="xadmin.open('添加知识','/author/index/zhishi/add',800,600)">
        ...
        $.get('http://127.0.0.1:7001/admin/news/list', { id: id }, function (res) {
          ...
          res.data.forEach(item => {
            li += `<tr>
                  ...
                  <td class="td-manage">
                    <a title="查看" onclick="xadmin.open('编辑','/author/index/zhishi/add?id=${item.id}')" href="javascript:;">
