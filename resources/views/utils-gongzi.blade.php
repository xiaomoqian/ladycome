...
<body>
    ...
    <div class="container-box">
      <div class="">
        <div class="container-box__content">
          <div class="nav">当前位置：<a href="{{route('index')}}">多广网</a>><a href="/utils">工具</a>>工资计算器</div>
          <div class="hd">
            <div class="tool-nav clearfix">
              ...
              <a stat-info="jrmall_pc_fangdaical_gongzi" href="/utils/gongzi" title="工资计算器" class="active">工资计算器</a>
          ...
          <div class="container-box__content--box row" style="max-width: 400px; margin:0 auto;">
            <form class="col-xs-12 col-md-12 col-sm-12">
              <b style="font-weight: bold;font-size: 20px;">工资计算器</b>
              ...
              <div class="input-group mb-1">
                <div class="input-group-addon">
                  <span class="input-group-text">个人公积金系数</span>
                </div>
                <input type="text" class="form-control progongji" id="txtRate" value="" />
                <div class="input-group-addon">
              ...
              <div class="input-group mb-1">
                <div class="input-group-addon">
                  <span class="input-group-text">公司公积金系数</span>
                </div>
                <input type="text" class="form-control comgongji" id="txtRate" value="" />
                <div class="input-group-addon">
                  <span class="input-group-text">%</span>
                </div>
              </div>
              <div class="input-group mb-1">
                <div class="input-group-addon">
                  <span class="input-group-text">公积金基数</span>
                </div>
                <input type="text" class="form-control gongjinum" id="txtRate" value="" />
                <div class="input-group-addon">
                  <span class="input-group-text">元</span>
                </div>
              </div>
              <div class="input-group mb-1">
                <div class="input-group-addon">
                  <span class="input-group-text">社保基数</span>
                </div>
                <input type="text" class="form-control shebaonum" id="txtRate" value="" />
                <div class="input-group-addon">
                  <span class="input-group-text">元</span>
                </div>
              </div>
            ...
            <form class="col-xs-12 col-md-12">
              ...
              <div class="input-group mb-1 shuihougongzi">
                <div class="input-group-addon">
                  <span class="input-group-text">税后月薪</span>
                </div>
              ...
              <div class="input-group mb-1 gongjijings">
                <div class="input-group-addon">
                  <span class="input-group-text">住房公积金</span>
                </div>
                <input type="text" disabled class="form-control" id="txtRate" value="" />
                <div class="input-group-addon">
                  <span class="input-group-text">元</span>
              ...
              <div class="input-group mb-1 gerensui">
                <div class="input-group-addon">
              ...
              <div class="input-group mb-1 shebaos">
                <div class="input-group-addon">
                  <span class="input-group-text">社会保险</span>
                </div>
                <input type="text" disabled class="form-control" id="txtRate" value="" />
                <div class="input-group-addon">
                  <span class="input-group-text">元</span>
  ...
  <script>
    function btnCalc_onclick() {
      if (!$(".comgongji").val() || !$(".progongji").val() || !$(".shebaonum").val() || !$(".gongjinum").val()) {
        alert('请认真填写工资信息后在计算')
        return false
      }
      ...
      //公积金系数输入为准
      yuedata.gongjicom = $(".comgongji").val()
      yuedata.gongjipre = $(".progongji").val()
      //社保基数重置
      if ($(".shebaonum").val() != "请输入社保基数") {
        yuedata.shebaocard = parseFloat($(".shebaonum").val())
      }
      if (parseFloat(yuedata.shebaocard) > parseFloat(yuedata.shebaoup)) {
        yuedata.shebaocard = parseFloat(yuedata.shebaoup)
      } else if (parseFloat(yuedata.shebaocard) < parseFloat(yuedata.shebaodown)) {
        yuedata.shebaocard = parseFloat(yuedata.shebaodown)
      }
      //公积金基数重置
      if ($(".gongjinum").val() != "请输入公积金基数") {
        yuedata.gongjicard = $(".gongjinum").val()
      }
      if (parseFloat(yuedata.gongjicard) > parseFloat(yuedata.gongjiup)) {
        yuedata.gongjicard = parseFloat(yuedata.gongjiup)
      } else if (parseFloat(yuedata.gongjicard) < parseFloat(yuedata.gongjidown)) {
        yuedata.gongjicard = parseFloat(yuedata.gongjidown)
      }
      //开始计算结果
      //住房公积金
      ...
      var c =
        gong -
        3500 -
        yuedata.shebaocard * yuedata.yanglaopre * 0.01 -
        yuedata.shebaocard * yuedata.yiliaopre * 0.01 -
        yuedata.shebaocard * yuedata.siyepre * 0.01 -
        yuedata.gongjicard * yuedata.gongjipre * 0.01
      //个人所得税
      var g = 0
      if (c < 0) {
        g = 0
      ...
      //	展示数据
      var shuihougongzi = c + 3500 - g //税后月薪
      var gongjijings = yuedata.gongjicard * yuedata.gongjipre * 0.01 //住房公积金
      var gerensui = g //个人所得税
      var shebaos = gong - gerensui - shuihougongzi - gongjijings //社会保险
      $('.shuihougongzi input').val(shuihougongzi.toFixed(2))
      $('.gongjijings input').val(gongjijings.toFixed(2))
      $('.gerensui input').val(gerensui.toFixed(2))
      $('.shebaos input').val(shebaos.toFixed(2))
    }
    ...
    function btnReset_onclick() {
      ...
      $(".shebaonum").val('')
      $(".gongjinum").val('')
      $('.shuihougongzi input').val('')
      $('.gongjijings input').val('')
      $('.gerensui input').val('')
      $('.shebaos input').val('')
    }
