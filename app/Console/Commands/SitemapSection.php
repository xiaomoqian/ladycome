...
//        $siteMap[] = '</urlset>';
        ...
        $siteMap[] = '</DOCUMENT>';
        $this->zip();
        file_put_contents(public_path("xml_section.xml"),$siteMap);
    }
    ...
    protected  function handles($siteMap,$page = 1){
        ...
        $siteMap[] = '  <sitemap>';
        $siteMap[] = "    <loc>".trim(config("app.url"),"/")."/duoguang/section_{$page}.xml"."</loc>";
...
',$value['seo_desc']);
    ...
    {
        $zipFile = public_path('xml_section.zip');
