...
class SitemapHeadlines extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sitemap:headlines';
     ...
     * @var string
     */
    protected $description = '生成Sitemap头条';
...
//        $siteMap[] = '</urlset>';
        ...
        $siteMap[] = '</DOCUMENT>';
        $this->zip();
        file_put_contents(public_path("xml_headlines.xml"),$siteMap);
    }
...
',$value['seo_desc']);
    ...
    {
        $zipFile = public_path('xml_headiles.zip');
